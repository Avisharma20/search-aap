...
public class CourseSpecificationsBuilder {
    ...
    public final CourseSpecificationsBuilder with(final String key, final String operation, final Object value, final String prefix, final String suffix) {
        return with(null, key, operation, value, prefix, suffix);
    }

    public final CourseSpecificationsBuilder with(final String orPredicate, final String key, final String operation, final Object value, final String prefix, final String suffix) {
    ...
    public Specification<Course> build() {
        ...
        Specification<Course> result = new StudentSpecification(params.get(0));
